...
class PromoCake(Cake, Promo):
    ...
    def __init__(self, cake, promo):
        super(PromoCake, self).__init__(cake.name, cake.kind, cake.taste, cake.additives, cake.filling)
        Promo.__init__(self, promo.name, promo.discount, promo.start_date, promo.end_date,
                                        promo.minimal_order)
